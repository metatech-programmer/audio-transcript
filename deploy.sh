...
echo "  3. Add environment variables in Vercel dashboard (do NOT paste keys in public places):"
echo "     - GROQ_API_KEY (set via Vercel dashboard)"
echo "     - GROQ_LLM_API_KEY (set via Vercel dashboard)"
echo ""
